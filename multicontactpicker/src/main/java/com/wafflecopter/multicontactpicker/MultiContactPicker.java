...
public class MultiContactPicker {
    ...
    public static class Builder implements Serializable {
        ...
        public Intent showPickerForResult(int requestCode) {
          Intent intent = new Intent();
            if (acc != null) {
                intent = new Intent(acc, MultiContactPickerActivity.class);
...
//                acc.startActivityForResult(intent, requestCode);
                ...
                if(frag.getActivity() != null) {
                    intent = new Intent(frag.getActivity(), MultiContactPickerActivity.class);
                    intent.putExtra("builder", this);
