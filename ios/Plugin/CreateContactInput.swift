...
public class CreateContactInput {
    ...
    public class PhoneInput {
        ...
        init(_ fromJSONObject: JSObject) {
            let type = MultiContactSelect.phoneTypeMap.getValue(fromJSONObject["type"] as? String)
    ...
    public class EmailInput {
        ...
        init(_ fromJSONObject: JSObject) {
            let type = MultiContactSelect.emailTypeMap.getValue(fromJSONObject["type"] as? String)
    ...
    public class PostalAddressInput {
        ...
        init(_ fromJSONObject: JSObject) {
            let type = MultiContactSelect.postalAddressTypeMap.getValue(fromJSONObject["type"] as? String)
